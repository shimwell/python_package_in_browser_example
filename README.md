This repo makes use of the [Real Python example]([url](https://realpython.com/pyscript-python-in-browser/)) to show a python package (located at src dir) running in the browser using pyscript
